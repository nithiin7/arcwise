...
def _record_to_session(record: SessionRecord) -> Session:
    ...
    architecture = Architecture(
        ...
        component_alternatives=raw_arch.get("component_alternatives", {}),
        component_tradeoffs=raw_arch.get("component_tradeoffs", {}),
...
def _arch_to_json(session: Session) -> dict[str, Any]:
    ...
    return {
        ...
        "component_alternatives": arch.component_alternatives,
        "component_tradeoffs": arch.component_tradeoffs,
